...
if not filtered_df.empty:
    ...
    if not all_map_points_df.empty:
        ...
        scatterplot_layer = pdk.Layer(
            ...
            get_color='[200, 30, 0, 200]' if all_map_points_df['is_store'].any() else '[0, 100, 200, 150]', # Different color for stores vs. 'Sin tienda'
...
if not filtered_df.empty:
    ...
    if not filtered_df.empty and 'transaction_time' in filtered_df.columns:
        ...
        fig_hourly = px.line(
            ...
            labels={'hour': 'Hora del Día', 'Número de Transacciones'}
        )
